...
return;if((keyCode==27)&&t.showingPanel)
t.togglePanel();if((keyCode==78))
...
this.postMessage({action:"togglePanel",showing:this.showingPanel});if(this.showingPanel)
this.iframe[0].contentWindow.focus();else
window.focus();},loadIframe:function(){var t=this,args=[],src,lang,queries;if(t.iframe===null){t.panel.addClass('loadingIframe');if(t.isJetpack){args.push('jetpack=true');if(t.linkAccountsURL){args.push('link_accounts_url='+escape(t.linkAccountsURL));}}
